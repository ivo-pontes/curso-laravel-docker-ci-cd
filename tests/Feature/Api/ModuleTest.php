...
class ModuleTest extends TestCase
{
    ...
    public function test_modules_by_course_not_found()
    {
        $course = Course::factory()->create();
    ...
    public function test_module_by_course_not_found()
    {
        $course = Course::factory()->create();
        
        $response = $this->getJson("/courses/{$course->uuid}/modules/fake_data",[]);
